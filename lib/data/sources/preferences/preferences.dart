...
import 'package:sentit/data/sources/preferences/preferences_key.dart';
...
class Preferences {
  Preferences({
    ...
    accessTokenPreferences =
        SharedPref<String>(key: PreferencesKey.accessTokenKey, pref: pref);
  }

  final SharedPreferences pref;

  // Add your common preferences here.
  late SharedPref<String> accessTokenPreferences;
}
